...
export const config: SiteConfig = {
  ...
  description: 'The single source of truth for all MCP Tool Shop tools — schema-validated metadata, opinionated bundles, and a pre-built search index.',
  logoBadge: 'TR',
  ...
  hero: {
    ...
    description: 'The metadata-only single source of truth for all MCP Tool Shop tools. Schema-validated on every commit. Opinionated bundles built by rules, not manual curation. Pre-built search index ships inside the package. Pin a version — get deterministic metadata every time.',
  ...
  sections: [
    ...
    },
    {
      ...
      subtitle: 'Membership is determined by declarative rules — not manual curation.',
